  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      ...
      <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-4 mt-3 mb-2 ">
        ...
        <div class="card pt-5 card-timeline px-2 border-none mb-4">
          ...
          <ul class="bs4-order-tracking">
            <li class="step active">
              <div><a href="status.php"><i class="fas fa-spinner"></a></i></div> Pending
            </li>
            <li class="step active">
          ...
          <div class="card-deck">
            <div class="  col-lg-6 offset-md-3 mb-4 ">
              <img class="card-img-top" src="img/receive.png" style="width:100px" alt="Card image cap">
              <div class="card-body">
                <p class="card-text">2. RECEIVED - You already received an update.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        $sql_get = mysqli_query($conn, "SELECT * FROM complaints where complainant_id = {$_SESSION['login_id']} and status = 2");
              ...
              <div class="container mt-4">
                <table class="table   table-hover">
                  ...
                  <tbody>
                    <?php
                    $i = 1;
                    $qry = $conn->query("SELECT * FROM complaints where complainant_id = {$_SESSION['login_id']} and status = 2 order by unix_timestamp(date_created) desc ");
                    if ($qry->num_rows > 0) :
                    ...
                    ?>
                      ...
                      ?>
                      <tr>
                        <th class="text-center" colspan="6">No complaint report.</th>
                      </tr>
                    <?php
                    endif;
                    ?>
        ...
        $sql_get = mysqli_query($conn, "SELECT * FROM crime where complainant_id = {$_SESSION['login_id']} and status = 2");
                ...
                <div class="container">
                  <table class="table   table-hover">
                    ...
                    <tbody>
                      <?php
                      $i = 1;
                      $qry = $conn->query("SELECT * FROM crime where complainant_id = {$_SESSION['login_id']} and status = 2 order by unix_timestamp(date_created) desc ");
                      if ($qry->num_rows > 0) :
                        while ($row = $qry->fetch_array()) :
                      ?>
                          <tr>
                            ...
                            <td class="">
                              ...
                              <p>Location: <b><?php echo $row['crime_barangay'] ?></b>
                        ...
                        ?>
                        <tr>
                          <th class="text-center" colspan="6">No crime report.</th>
                        </tr>
                      <?php
                      endif;
                      ?>
        ...
        $sql_get = mysqli_query($conn, "SELECT * FROM missing where complainant_id = {$_SESSION['login_id']} and status = 2");
        ...
        <div class="accordion mb-2" id="accordionExample">
          <div class="card">
            ...
            <div id="missing" class="collapse" aria-labelledby="heading3" data-parent="#accordionExample">
              <div class="card-body">
                <div class="container">
                  <table class="table   table-hover">
                    <thead>
                    ...
                    <tbody>
                      <?php
                      $i = 1;
                      $qry = $conn->query("SELECT * FROM missing where complainant_id = {$_SESSION['login_id']} and status = 2 order by unix_timestamp(date_created) desc ");
                      if ($qry->num_rows > 0) :
                        while ($row = $qry->fetch_array()) :
                      ?>
                          <tr>
                        ...
                        ?>
                        <tr>
                          <th class="text-center" colspan="6">No missing report.</th>
                        </tr>
                      <?php
                      endif;
                      ?>
