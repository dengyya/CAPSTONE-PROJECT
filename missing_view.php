                        ...
                        <div class="contact-info-section mb-5 margin-40px-tb">
                            <ul class="list-style9 no-margin">
                                <li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-7">
                                            <p><?php echo $missing_fname ?>
                                                <?php echo $missing_lname ?>
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-5">
                                            <i class="fas fa-sort-numeric-up-alt text-dark"></i>
                                            <strong class="margin-10px-left "> Age:</strong>
                                        </div>
                                        <div class="col-md-7 col-7">
                                ...
                                <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-5">
                                            ...
                                            <strong class="margin-10px-left text-dark">Gender:</strong>
                                        </div>
                                        <div class="col-md-7 col-7">
                                ...
                                <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-5">
                                            ...
                                            <strong class="margin-10px-left text-dark">Informer's Number:</strong>
                                        </div>
                                        <div class="col-md-7 col-7">
                                ...
                                <li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-5">
                                            ...
                                            <strong class="margin-10px-left "> MIssing Person Description:</strong>
                                        </div>
                                        <div class="col-md-7 col-7">
                                            <p><?php echo $physical_description ?>
                                                <?php echo $missing_cloth ?>
                                            <p><?php echo $missing_address ?>
                                            </p>
                                        </div>
                                    </div>
