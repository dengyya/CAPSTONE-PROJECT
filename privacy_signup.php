...
<div class="container-fluid">
        <form action="" id="terms-frm">
                ...
                <center>
                        <button class="button btn btn-secondary btn-sm" type="button" data-dismiss="modal">Back</button>
                </center>
...
<script>
        $('#privacy_signup').click(function() {
                if ('<?php echo !isset($_SESSION['login_id']) ? 1 : 0 ?>' == 1) {
                        uni_modal("Create an Account", 'signup.php', "large");
                        return false;
                }
