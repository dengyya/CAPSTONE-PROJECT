            ...
            <div class="">
                ...
                <table class=" table table-bordered " id='report-list'>
                    ...
                    <tbody>
                      ...
                      inner join stations s on s.id = rt.station_id inner join users u on u.id = ca.dispatched_by where c.status = 5 
                                    ...
                                    <td class="text-justify">
                                        <small>
                                            ...
                                            <p><?php echo $row['incident_location'] ?>,
                                                ...
                                                <?php echo $row['incident_province'] ?></br> </p>
                                        </small>
                                    </td>

                                    <td class="text-center"><?php echo $row['sname'] . ' - ' . $row['rname'] ?></td>

                                    <td class="text-center"><?php echo ucwords($row['uname']) ?></td>

                                    <td class="text-center"><?php echo ucwords($row['remarks']) ?></td>

                                    <td class="text-center"><?php echo ucwords($row['cancellation_reason']) ?></td>
...
<script>
    ...
    $('#print').click(function() {
        ...
        ns.append(_c)
        var nw = window.open('Cancel', '_cancelled_reports', 'width=900,height=600')

        nw.document.write('<p class="text-center"><b>Complaints Report of <br> Barangay Balasing </b></p><br>')
        nw.document.write('<p class="text-center"><b>Cancellation of Reports as of <?php echo date("F, Y", strtotime($month)) ?></b></p><br>')
