                    ...
                    <div class="padding">
                        <div class="row ">
                            <div class="col-md-8 offset-md-2 form">
                                <div class="">
                                    <div class="card-header mb-2"><strong>Forgot Password?</strong>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="forgot-password.php" method="POST" autocomplete="">
                                            ...
                                            <div class="form-group ">
                                                <input class="form-control button bg-dark text-white" type="submit" name="check-email" value="Continue">
                                            </div>
